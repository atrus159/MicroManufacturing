...
public class Level1Tutorial : tutorialParent
{
    ...
    public override void Start()
    {
        ...
        cameraCheck = new GameObject();
        cameraCheck.AddComponent<cameraPanCheck>();
        cameraCheck.GetComponent<cameraPanCheck>().myTutorial = this;
        cameraCheck.name = "camera pan check";

        dropdownCheck = new GameObject();
        dropdownCheck.AddComponent<dropdownSelectCheck>();
        dropdownCheck.GetComponent<dropdownSelectCheck>().myTutorial = this;
        dropdownCheck.name = "dropdown select check";
    }
    override public void initializeChecks()
    {
        ...
        tutorialChecks.Add(delegate
        {
            ...
            GameObject newObj = Instantiate(cameraCheck);
        });
        ...
        tutorialChecks.Add(delegate
        {
            displayText("<b>We have 3 metals for you to choose from, <b><color=#00EBFF>chromium</color><b>, <b><color=#717171>aluminum</color><b> and <b><color=#AB8100>Gold</color><b>.\nYou can select a metal from the dropdown menu in the top left.", new Vector2(500, 100));
            Dropdown.SetActive(true);
        });
        tutorialChecks.Add(delegate { 
            displayTextFree("Click on the dropdown and select <b><color=#717171>aluminum</color><b>.", new Vector2(400, 200));
        });
