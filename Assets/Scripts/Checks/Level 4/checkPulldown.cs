...
public class checkPulldown : levelRequirementParent
{
    ...
    public override void onStart()
    {
        ...
        RectangleStructure chrome = new RectangleStructure(control.materialType.chromium, 1, new Vector3Int(3, 1, 3), new Vector3Int(60, 1, 60), 1, new[] { true, false, false }) ;
        RectangleStructure gold = new RectangleStructure(control.materialType.gold, 1, new Vector3Int(3, 1, 3), new Vector3Int(60, 1, 60), 1, new[] { true, false, false });
